...
$stmt = $pdo_main->query("SELECT COUNT(*) FROM deviz_evenimente");
$total_items = $stmt->fetchColumn();
$total_pages = ceil($total_items / $items_per_page);

// Obținere evenimente pentru pagina curentă
error_log('Obținere evenimente din baza de date');
$stmt = $pdo_main->prepare("SELECT * FROM deviz_evenimente ORDER BY Data DESC LIMIT ? OFFSET ?");
...
<body>
    <div class="page-container">
        <div class="page-header">
            ...
            <a href="?action=curs_form" class="btn btn-primary">
                            ...
                            <tr<?= $eveniment['Vizibil'] == 0 ? ' style="background-color:#ffeaea;"' : '' ?>>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="?action=curs_form&cod=<?= $eveniment['codCalendar'] ?>" 
                                        ...
                                        <button type="button" 
                                                ...
                                                onclick="confirmDelete(<?= $eveniment['codCalendar'] ?>)"
                                                title="Șterge">
        ...
        <?php if ($total_pages > 1): ?>
            ...
            <nav aria-label="Navigare pagină">
                <ul class="pagination">
                    <?php if ($page > 1): ?>
                        <li class="page-item">
                            <a class="page-link" href="?action=cursuri&page=1">
                                <i class="fas fa-angle-double-left"></i>
                            </a>
                        </li>
                        <li class="page-item">
                            <a class="page-link" href="?action=cursuri&page=<?= $page - 1 ?>">
                    ...
                    if ($start_page > 1) {
                        echo '<li class="page-item"><a class="page-link" href="?action=cursuri&page=1">1</a></li>';
                        if ($start_page > 2) {
                    ...
                    for ($i = $start_page; $i <= $end_page; $i++) {
                        ...
                        echo '<a class="page-link" href="?action=cursuri&page=' . $i . '">' . $i . '</a>';
                        echo '</li>';
                    }
                    ...
                    if ($end_page < $total_pages) {
                        ...
                        echo '<li class="page-item"><a class="page-link" href="?action=cursuri&page=' . $total_pages . '">' . $total_pages . '</a></li>';
                    }
                    ?>
                    ...
                    <?php if ($page < $total_pages): ?>
                        ...
                        <li class="page-item">
                            <a class="page-link" href="?action=cursuri&page=<?= $total_pages ?>">
    ...
    function confirmDelete(cod) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch('/SoftAdmin/pages/devize/curs_delete.php', {
                    method: 'POST',
                    body: formData
                })
                .then(response => {
                ...
                .catch(error => {
                    ...
                    Swal.fire({
                        title: 'Eroare!',
                        text: 'A apărut o eroare la ștergerea cursului',
                        icon: 'error'
                    });
                });
            }
